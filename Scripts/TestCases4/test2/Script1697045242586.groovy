...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'blah blah')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Book Appointment'))

WebUI.waitForPageLoad(0)

WebUI.takeFullPageScreenshotAsCheckpoint('loginconfirmed')
